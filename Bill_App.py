...
class Bill_App:
    def __init__(self, root):
        ...
        title = Label(self.root, text="ABC Company",
    ...
    # ===================Medical====================================
        F2 = LabelFrame(self.root, text="Medical Purpose", font=('times new roman', 15, 'bold'), bd=10, fg="White", bg="#3C138B")
        F2.place(x=5, y=180, width=375, height=380)

        sanitizer_lbl = Label(F2, text="Sanitizer", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="White")
        ...
        mask_lbl = Label(F2, text="Mask", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="White")
        ...
        hand_gloves_lbl = Label(F2, text="Hand Gloves", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="White")
        ...
        dettol_lbl = Label(F2, text="Dettol", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="White")
        ...
        newsprin_lbl = Label(F2, text="Newsprin", font =('times new roman', 16, 'bold'), bg = "#3C138B", fg = "White")
        ...
        thermal_gun_lbl = Label(F2, text="Thermal Gun", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="White")
    ...
    # ==========GroceryItems===========================
        F3 = LabelFrame(self.root, text="Grocery Items", font=('times new roman', 15, 'bold'), bd=10, fg="White", bg="#3C138B")
        F3.place(x=390, y=180, width=370, height=380)

        rice_lbl = Label(F3, text="Rice", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="White")
        ...
        food_oil_lbl = Label(F3, text="Food Oil", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="white")
        ...
        wheat_lbl = Label(F3, text="Wheat", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="White")
        ...
        daal_lbl = Label(F3, text="Daal", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="white")
        ...
        flour_lbl = Label(F3, text="Flour", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="white")
        ...
        maggi_lbl = Label(F3, text="Maggi", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="white")
    ...
    # ===========ColdDrinks================================
        F4 = LabelFrame(self.root, text="Cold Drinks", font=('times new roman', 15, 'bold'), bd=10, fg="White", bg="#3C138B")
        F4.place(x=770, y=180, width=375, height=380)

        sprite_lbl = Label(F4, text="Sprite", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="White")
        ...
        limka_lbl = Label(F4, text="Limka", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="white")
        ...
        mazza_lbl = Label(F4, text="Mazza", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="white")
        ...
        coke_lbl = Label(F4, text="Coke", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="white")
        ...
        fanta_lbl = Label(F4, text="Fanta", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="white")
        ...
        mountain_duo_lbl = Label(F4, text="Mountain Duo", font=('times new roman', 16, 'bold'), bg="#3C138B", fg="white")
    ...
    # =================BillArea======================
        ...
        F5.place(x=1160, y=180, width=350, height=380)
    ...
    # =======================ButtonFrame=============
        F6 = LabelFrame(self.root, text="Bill Area", font=('times new roman', 14, 'bold'), bd=10, fg="White", bg="#3C138B")
        F6.place(x=0, y=560, relwidth=1, height=140)

        m1_lbl = Label(F6, text="Total Medical Price", font=('times new roman', 14, 'bold'), bg="#3C138B", fg="White")
        ...
        m2_lbl = Label(F6, text="Total Grocery Price", font=('times new roman', 14, 'bold'), bg="#3C138B", fg="White")
        ...
        m3_lbl = Label(F6, text="Total Cold Drinks Price", font=('times new roman', 14, 'bold'), bg="#3C138B", fg="White")
        ...
        m4_lbl = Label(F6, text="Medical Tax", font=('times new roman', 14, 'bold'), bg="#3C138B", fg="White")
        ...
        m5_lbl = Label(F6, text="Grocery Tax", font=('times new roman', 14, 'bold'), bg="#3C138B", fg="White")
        ...
        m6_lbl = Label(F6, text="Cold Drinks Tax", font=('times new roman', 14, 'bold'), bg="#3C138B", fg="White")
    ...
    # =======Buttons-======================================
        ...
        btn_f.place(x=770, width=710, height=105)
        ...
        print_btn = Button(btn_f, text="Print", command=self.print_bill, bg="#535C68", bd=2, fg="white", pady=15, width=12, font='arial 13 bold')
